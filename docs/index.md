...
![ChaWatcherIconSmall](../icons/ChaWatcherIconSmall.png)

ChaWatcher is an anti-cheat / outlier detector that uses machine-learning to detect outlier behaviours. It uses One-Class Support Vector Machine from my [DataPredict](https://aqwamcreates.github.io/DataPredict/) library.
